...
<body>
    <header>
        ...
        <nav>
            <ul>
                <li  style="border-bottom:2px solid #363636;"><a href="anasayfaOgretmen.php" ><img src="images/homePage.png" title="HomePage"></a></li>
    ...
    <main>
                ...
                <div class="gorevBilgi">
                    ...
                    <?php
                        ...
                        while($satir=mysqli_fetch_assoc($gonder)){ 
                            ...
                            ?>
                            <p style="margin-left: 25px;margin-right:15px;"><img src="images/bak1.png" style="width:10px;height:10px;margin-right: 5px;" title="Konu"><span style="font-size:12px;"><?php echo $gorevAdi ?></span></p>
                            <p><img src="images/saat1.png" style="width:10px;height:10px;margin-right: 10px;margin-left: 25px;" title="Son Teslim"><span style="font-size:12px;"><?php echo $sonTarih ?></span></p>
                            <p><img src="images/tamam2.png" style="width:10px;height:10px;margin-right: 10px;margin-left: 25px;" title="Durum"><span style="font-size:12px;"><?php echo $durum ?></span></p>
                            <p><?php $teslimDurumu ?></p>
                            <?php
                            echo '<a href="gorevSil.php?gorevId='.$gorevId.'" onclick="return uyari();" style="color:#363636;margin-left:95px; font-size:13px;">Sil</a>';
                            echo '<a href="gorevGuncelle.php?gorevId='.$gorevId.'&kimin='.$kim.'" style="color:#363636;margin-left:25px;font-size:13px;">Guncelle</a>'; 
                            echo '<p></p>';
                        }
                        echo '<p style="text-align:center;border-top:1px solid #eee9e9;padding-top:5%;"><a href="gorevEkle.php?kim='.$kim.'"><img class="gorevEkle" src="images/add.png" title="Add"></a></p>';   
                    ?>   
                </div>
            </div>
            <div class="kisi">
        ...
        <p style="text-align:center;"><a href="dosyaListele.php"><img src="images/open.png" title="Dosyalar" style="width:30px;height:30px;"></a></p> 
    </main>
</body>
<script>
    function uyari() {
